...
(function(){
  var legacy = {
    v:7,
    residents:[
      { id:"L1", unit:2, room:"210", name:"旧版 一郎", order:0, status:"in",
      ...
      { id:"L2", unit:5, room:"520", name:"旧版 花子", order:1, status:"in",
        permRaw:"食事はきざみ食です。", permShort:"", permUpdated:"2026-06-01", autoCarry:true },
      { id:"L3", unit:4, room:"430", name:"旧版 退居者", order:2, status:"out", leftAt:"2026-05-20",
    ...
    schedules:[ { id:"LS1", residentId:"L1", unit:2, date:"2026-06-10", kind:"受診",
                  start:"10:00", end:"", title:"定期受診", place:"旧版クリニック", dept:"内科",
                  family:"あり", note:"" } ],
    history:{version:1},
